                                                                ...
                                                                {matchupRosterData.team1.lineup.map((leftPlayer, idx) => {
                                                                    ...
                                                                    return (
                                                                        <div key={`starter-row-${idx}`} className="grid grid-cols-3 items-center border-b border-gray-200 last:border-b-0 py-2">
                                                                            {/* Left: name and subline (left-aligned) */}
                                                                            ...
                                                                            {/* Center: left score + position bubble + right score (dots flush with scores) */}
                                                                            <div className="flex items-center justify-center gap-2 h-10">
                                                                                <div className="flex items-center gap-2">
                                                                                    <div className="w-12 text-right text-sm font-semibold text-gray-800">{leftScore}</div>
                                                                                    <div className={`inline-block w-3 h-3 rounded-full ${outcomeLeft === 'win' ? 'bg-green-600' : outcomeLeft === 'loss' ? 'bg-red-600' : 'bg-gray-300'}`} />
                                                                                </div>
                                                                                ...
                                                                                <div className="flex items-center gap-2">
                                                                                    <div className={`inline-block w-3 h-3 rounded-full ${outcomeRight === 'win' ? 'bg-green-600' : outcomeRight === 'loss' ? 'bg-red-600' : 'bg-gray-300'}`} />
                                                                                    <div className="w-12 text-left text-sm font-semibold text-gray-800">{rightScore}</div>
                                                                                </div>
                                                                            </div>

                                                                            {/* Right: name and subline (right-aligned) */}
